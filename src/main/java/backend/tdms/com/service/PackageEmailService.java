        ...
        try {
            ...
            String htmlContent = """
                ...
                """.formatted(senderName, trackingNumber, receiverName, origin, destination, 
                            travelDate, expectedArrival, trackingNumber);
    ...
    public boolean sendPackageIncomingEmail(String to, String receiverName, String trackingNumber,
        ...
        try {
            ...
            String htmlContent = """
                        ...
                        <div style='padding: 20px;'>
                            ...
                            <div style='background-color: #dbeafe; padding: 15px; margin: 20px 0; border-left: 4px solid #3b82f6;'>
                                ...
                                <ul style='margin: 5px 0; padding-left: 20px;'>
                                    <li>Bring your <strong>National ID (%s)</strong></li>
                ...
                """.formatted(receiverName, trackingNumber, senderName, senderPhone, origin, destination,
                            travelDate, expectedArrival, packageDescription, 
                            "Required for collection", destination, trackingNumber);
    ...
    public boolean sendPackageArrivedEmail(String to, String receiverName, String trackingNumber,
        ...
        try {
            ...
            String htmlContent = """
                ...
                """.formatted(receiverName, trackingNumber, arrivalTime, collectionLocation, trackingNumber);
